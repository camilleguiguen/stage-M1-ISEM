...
# Format des noms OBLIGATOIRE (3 champs séparé par des '_'): <espece>_<chrom>_<commentaire>.fasta
# Ex : pdestructans_chrom1_run1.fasta ou ecoli_test_chrom2.fasta
input_dir: "input_data/" # mettre vos data dans ce dossier ou indiquer un autre path 

output_dir: "all_results"

# Pour tester sur un sous-ensemble : N premiers isolats de chaque FASTA.
n_first: null   # null = tous les isolats
